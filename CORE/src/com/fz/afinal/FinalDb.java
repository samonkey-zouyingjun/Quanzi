...
import com.fz.afinal.db.sqlite.CursorUtils;
import com.fz.afinal.db.sqlite.DbModel;
import com.fz.afinal.db.sqlite.ManyToOneLazyLoader;
import com.fz.afinal.db.sqlite.OneToManyLazyLoader;
import com.fz.afinal.db.sqlite.SqlBuilder;
import com.fz.afinal.db.sqlite.SqlInfo;
import com.fz.afinal.db.table.KeyValue;
import com.fz.afinal.db.table.ManyToOne;
import com.fz.afinal.db.table.OneToMany;
import com.fz.afinal.db.table.TableInfo;
import com.fz.afinal.exception.DbException;
...
//			
//			
//			for ( Object ob : sqlInfo.getBindArgsAsArray()) {
//				sb.append(ob).append(",");
//				
//			}
//			LogUtils.e("FFFFFF", sb.toString());
