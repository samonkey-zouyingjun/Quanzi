 ...
 */
package com.fz.afinal.bitmap.core;

import java.io.File;
import java.io.IOException;
import java.nio.ByteBuffer;

import com.fz.afinal.bitmap.core.BytesBufferPool.BytesBuffer;
import com.fz.afinal.bitmap.core.DiskCache.LookupRequest;
...
public class BitmapCache {
    ...
    */
    ...
    public void addToDiskCache(String url, byte[] data) {
        ...
        //Add to disk cache
        byte[] key = FinalUtils.makeKey(url);
        long cacheKey = FinalUtils.crc64Long(key);
    ...
    public boolean getImageData(String url, BytesBuffer buffer){
        ...
        try {
            ...
            if (FinalUtils.isSameKey(key, request.buffer)) {
