...
//				LayoutParams.WRAP_CONTENT,Gravity.RIGHT|Gravity.TOP);
		...
		FrameLayout.LayoutParams msgParams = new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
				(int) (16 * scale + 0.5f),Gravity.RIGHT|Gravity.TOP);
		
		FrameLayout.LayoutParams msg = new FrameLayout.LayoutParams((int) (8* scale + 0.5f),
