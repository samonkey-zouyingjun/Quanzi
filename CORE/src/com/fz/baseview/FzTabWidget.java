...
//                attrs, R.styleable.TabWidget, R.attr.tabWidgetStyle, 0);
...
//        final TypedArray a = context.obtainStyledAttributes(
//                attrs, R.styleable.TabWidget, defStyleAttr, 0);
//        setStripEnabled(a.getBoolean(R.styleable.TabWidget_tabStripEnabled, true));
//        setLeftStripDrawable(a.getDrawable(R.styleable.TabWidget_tabStripLeft));
//        setRightStripDrawable(a.getDrawable(R.styleable.TabWidget_tabStripRight));
//
...
//    @SuppressLint("NewApi") public FzTabWidget(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        event.setClassName(FzTabWidget.class.getName());
...
//        info.setClassName(FzTabWidget.class.getName());
//    }
