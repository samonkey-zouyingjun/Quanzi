...
import com.fz.R;
import com.fz.pulltorefresh.library.internal.FlipLoadingLayout;
import com.fz.pulltorefresh.library.internal.LoadingLayout;
import com.fz.pulltorefresh.library.internal.RotateLoadingLayout;
import com.fz.pulltorefresh.library.internal.Utils;
import com.fz.pulltorefresh.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private LoadingMode mLoadingMode = LoadingMode.getDefault();
...
//	}
	...
	protected LoadingLayout createLoadingLayout(Context context, Mode mode,int customLayout, TypedArray attrs) {
		LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout(context, mode,
				customLayout,getPullToRefreshScrollDirection(), attrs);
		layout.setVisibility(View.INVISIBLE);
		return layout;
	}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_customLayout))
		{
			customLayoutId = 
			a.getResourceId(R.styleable.PullToRefresh_customLayout, 0);
		}
		...
		mHeaderLayout = createLoadingLayout(context, Mode.PULL_FROM_START,getCustomLayoutId(), a);
		mFooterLayout = createLoadingLayout(context, Mode.PULL_FROM_END,getCustomLayoutId(), a);
	...
	public void setLoadingMode(LoadingMode mLoadingMode)
	{
	...
	public static enum AnimationStyle {
		...
		LoadingLayout createLoadingLayout(Context context, Mode mode,int customLayout, Orientation scrollDirection, TypedArray attrs) {
			switch (this) {
				case ROTATE:
				default:
					return new RotateLoadingLayout(context, mode, customLayout,scrollDirection, attrs);
				case FLIP:
					return new FlipLoadingLayout(context, mode,customLayout, scrollDirection, attrs);
			}
		}
	}
	...
	public static enum LoadingMode {
		 ...
		 */
		static LoadingMode mapIntToValue(final int modeInt) {
			for (LoadingMode value : LoadingMode.values()) {
