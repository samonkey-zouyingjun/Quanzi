...
import com.fz.exception.FzException;
...
//    }
    ...
    public static int gc(Context cxt) {
            ...
            for (RunningAppProcessInfo process : processList) {
                ...
                if (process.importance > RunningAppProcessInfo.IMPORTANCE_VISIBLE) {
                    ...
                    for (String pkgName : pkgList) {
                        LogUtils.d(SystemUtils.class.getName(),"======正在杀死包名：" + pkgName);
                        try {
        ...
        LogUtils.d(SystemUtils.class.getName(),"清理了" + (getDeviceUsableMemory(cxt) - i)
                + "M内存");
        return count;
    }
