...
public class DateTimeUtils
{
	...
	public static String formatCalToSCString(Calendar car)
	{
		...
		if (car != null)
		{
			...
			if (1 + car.get(2) >= 10) str = str + String.valueOf(1 + car.get(2)) + "月";
			else str = str + "0" + String.valueOf(1 + car.get(2)) + "月";
			if (car.get(5) >= 10) str = str + String.valueOf(car.get(5)) + "日";
			else str = str + "0" + String.valueOf(car.get(5)) + "日";
		}
		else
		{
			str = null;
	...
	public static String formatCalendarToMiddleString(Calendar paramCalendar)
	{
		...
		// 月
		if (1 + paramCalendar.get(2) >= 10) str = str + String.valueOf(1 + paramCalendar.get(2)) + "-";
		else str = str + "0" + String.valueOf(1 + paramCalendar.get(2)) + "-";
		// 日
		if (paramCalendar.get(5) >= 10) str = str + String.valueOf(paramCalendar.get(5));
		else str = str + "0" + String.valueOf(paramCalendar.get(5));
		str = str + " ";
		// 时
		if (paramCalendar.get(11) >= 10) str = str + String.valueOf(paramCalendar.get(11)) + ":";
		else str = str + "0" + String.valueOf(paramCalendar.get(11)) + ":";
		// 分
		if (paramCalendar.get(12) >= 10) str = str + String.valueOf(paramCalendar.get(12));
		else str = str + "0" + String.valueOf(paramCalendar.get(12));
		// 秒
		/*
	...
	public static String formatCalendarToString(Calendar paramCalendar)
	{
		...
		if (paramCalendar.get(13) >= 10) str = str + String.valueOf(paramCalendar.get(13));
		else str = str + "0" + String.valueOf(paramCalendar.get(13));
		return str;
	}
	...
	public static Calendar formatSCStringToCalendar(String paramString)
	{
		...
		if ((paramString != null) && (paramString != "")) localCalendar = formatStringToCalendar(fixDateString(paramString));
	...
	public static Calendar formatStringToCalendar(String dateStr)
	{
		...
		if ((dateStr != null) && (dateStr != ""))
		{
			...
			if (dateArr.size() != 3)
			{
				if (dateArr.size() == 6 || dateArr.size() == 7) car.set(Integer.parseInt((String) dateArr.get(0)),
						Integer.parseInt((String) dateArr.get(1)) - 1, Integer.parseInt((String) dateArr.get(2)),
						Integer.parseInt((String) dateArr.get(3)), Integer.parseInt((String) dateArr.get(4)),
						Integer.parseInt((String) dateArr.get(5)));
			}
			else car.set(Integer.parseInt((String) dateArr.get(0)), Integer.parseInt((String) dateArr.get(1)) - 1,
					Integer.parseInt((String) dateArr.get(2)), 0, 0, 0);
		}
		return car;
	}
	...
	{
		String str;
		if (paramString != null) str = getFieldStringFromCalendar(formatStringToCalendar(paramString), paramInt);
		else str = "";
		return str;
	}
	...
	{
		Calendar localCalendar;
		if ((paramString != null) && (paramString.length() != 0)) localCalendar = getIntervalDateTime(
	...
	{
		int i;
		if ((paramString1 != null) && (paramString2 != null)) i = getIntervalDays(formatStringToCalendar(paramString1),
	...
	public static boolean isLeapyear(String paramString)
	{
		...
		else
		{
			...
			if (((year % 100 != 0) || (year % 400 != 0)) && ((year % 100 == 0) || (year % 4 != 0))) i = false;
			else i = true;
		}
		return i;
	}
